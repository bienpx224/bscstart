...
contract SafemoonFork is Context, IERC20, Ownable {
  ...
  uint256 private _tTotal = 800000000000 * 10**6 * 10**9; //CHANGE_OPTIONAL: total supply of token. Recommended to keep unchanged
  uint256 private _rTotal = (MAX - (MAX % _tTotal));
  uint256 private _tFeeTotal;

  string private _name = "BscStart"; //CHANGE_REQUIRED: name of token
  string private _symbol = "BS"; //CHANGE_REQUIRED: ticker of token, usually 3 letter
